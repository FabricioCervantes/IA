...
function create() {
  ...
  bala = juego.add.sprite(w - 100, h - 30, "bala");
...
function update() {
  ...
  if (modoAuto == true) {
    var accion = datosDeEntrenamiento([
      despBala,
      velocidadBala,
      despBalaDos,
      velocidadBalaDos,
  ...
  if (modoAuto == false && bala.position.x > 0) {
    datosEntrenamiento.push({
      input: [despBala, velocidadBala, despBalaDos, velocidadBalaDos],
      output: [estatusAire, estatusAireEnX],
    });
    console.log(
      despBala,
      +" " + velocidadBala,
