...
function resetBalaDiagonal() {
  balaDiagonal.position.set(w - 300, 10);
  balaDiagonal.body.velocity.x = 0;
  balaDiagonal.body.velocity.y = 0;
  balaDiagonalD = false;
}

function launchBalaDiagonal() {
